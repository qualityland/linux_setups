...
# on an Pop!_OS 20.04 LTS machine.
...
apt install -y build-essential libssl-dev libxml2-dev libcurl4-openssl-dev libmariadbclient-dev libxt-dev libopenblas-dev
