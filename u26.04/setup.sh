...
# on an Ubuntu 26.04 (Resolute Raccoon) machine.
...
apt install -y jags libzmq3-dev libnode-dev libfontconfig1-dev default-jre default-jdk libmagick++-dev cmake libglpk-dev libmpfr-dev
apt install -y libcairo2-dev libgsl-dev libharfbuzz-dev libfribidi-dev r-bioc-rbgl libudunits2-dev libabsl-dev
...
gdebi -n rstudio-2026.04.0-526-amd64.deb
